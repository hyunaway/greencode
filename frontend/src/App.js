        ...
        {step === 3 && (
          ...
          >
            ...
            >
              ...
              <path
                d="M 40 50 L 45 45 M 60 50 L 65 55 M 50 66 L 45 71"
                strokeWidth="4"
              />
            </motion.g>
          </motion.g>
  ...
  return (
    <>
      <style>{`
        ...
        .intro-header { padding: 140px 24px 80px; text-align: center; }
        ...
        /* 새로 추가된 프로젝트 배경 섹션 */
        .project-background { padding: 80px 24px; background: var(--page-bg); }
        ...
        .bg-card { background: #fff; padding: 40px 30px; border-radius: 20px; border: 1px solid var(--divider); flex: 1; box-shadow: 0 4px 20px rgba(0,0,0,0.02); }
        .bg-card h3 { color: var(--brand-dark); font-size: 1.3rem; font-weight: 800; margin-bottom: 20px; text-align: center; }
        .bg-card p { color: var(--font-secondary); font-size: 1.1rem; line-height: 1.7; word-break: keep-all; text-align: justify; }
        ...
        .data-metrics {
          padding: 100px 24px; background: var(--page-bg); text-align: center; border-top: 1px solid var(--divider);
        }
        .metrics-grid {
      ...
      <div className="data-metrics">
        ...
        <p style={{ color: "var(--font-secondary)", fontSize: "1.1rem" }}>
        ...
        <div className="metrics-grid">
          <div className="metric-card">
            ...
            <p style={{ color: "var(--font-secondary)", marginTop: "8px" }}>
              이번 학기에 심은 소나무 효과
            </p>
          </div>
          <div className="metric-card">
          ...
          >
            ...
            <div
              style={{
                ...
                fontWeight: "bold",
                color: "#fff",
                backgroundColor: stepInfo.accent,
                padding: "10px 24px",
                borderRadius: "99px",
